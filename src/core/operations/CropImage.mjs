...
class CropImage extends Operation {
    ...
    constructor() {
        ...
        this.module = "Image";
        this.description = "将图像裁剪到指定的区域，或自动裁剪边缘。<br><br><b><u>自动裁剪</u></b><br>自动从图像中裁剪相同颜色的边框。<br><br><u>自动裁剪容差</u><br>像素之间颜色差异容差的百分比值。<br><br><u>仅自动裁剪帧</u><br>仅裁剪真实帧（所有边必须具有相同的边框）<br><br><u>对称自动裁剪</u><br>强制自动裁剪对称（上/下和左/右裁剪相同数量）<br><br><u>自动裁剪保留边框</u><br>图像周围保留的边框像素数。";

...
class TripleDESDecrypt extends Operation {
    ...
    constructor() {
        ...
        this.module = "Ciphers";
        this.description = "Triple DES 对每个块应用 DES 三次以增加密钥大小。<br><br><b>密钥：</b> Triple DES 使用 24 字节（192 位）的密钥长度。<br><br><b>IV：</b> 初始化向量应为 8 字节长。如果未输入，将默认为 8 个空字节。<br><br><b>填充：</b> 在 CBC 和 ECB 模式下，将默认使用 PKCS#7 填充。";

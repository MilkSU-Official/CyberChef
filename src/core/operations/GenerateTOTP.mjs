...
class GenerateTOTP extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.description = "基于时间的一次性密码算法（TOTP）是一种从共享密钥和当前时间计算一次性密码的算法。它已被采纳为互联网工程任务组标准 RFC 6238，是开放认证倡议（OAUTH）的基石，并用于多种双因素认证系统。TOTP 是一种计数器为当前时间的 HOTP。<br><br>将密钥作为输入，或留空以生成随机密钥。T0 和 T1 以秒为单位。";

...
class UNIXTimestampToWindowsFiletime extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.description = "将 UNIX 时间戳转换为 Windows 文件时间值。<br><br>Windows 文件时间是一个 64 位值，表示从 1601 年 1 月 1 日 UTC 以来的 100 纳秒间隔数。<br><br>UNIX 时间戳是一个 32 位值，表示从 1970 年 1 月 1 日 UTC（UNIX 纪元）以来的秒数。<br><br>此操作还支持以毫秒、微秒和纳秒为单位的 UNIX 时间戳。";

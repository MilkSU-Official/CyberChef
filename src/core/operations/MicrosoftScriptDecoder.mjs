...
class MicrosoftScriptDecoder extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.description = "解码使用 Microsoft 自定义编码进行编码的 Microsoft 编码脚本文件。这些通常是 VBS（Visual Basic Script）文件，被编码后重命名为 '.vbe' 扩展名，或 JS（JScript）文件重命名为 '.jse' 扩展名。<br><br><b>示例</b><br><br>编码后：<br><code>#@~^RQAAAA==-mD~sX|:/TP{~J:+dYbxL~@!F@*@!+@*@!&amp;@*eEI@#@&amp;@#@&amp;.jm.raY 214Wv:zms/obI0xEAAA==^#~@</code><br><br>解码后：<br><code>var my_msg = &#34;Testing <1><2><3>!&#34;;\n\nVScript.Echo(my_msg);</code>";

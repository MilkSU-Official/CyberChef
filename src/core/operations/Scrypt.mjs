...
class Scrypt extends Operation {
    ...
    constructor() {
        ...
        this.name = "Scrypt";
        this.module = "Crypto";
        this.description = "scrypt 是由 Colin Percival 创建的基于密码的密钥派生函数 (PBKDF)。该算法特意设计为通过需要大量内存来提高大规模定制硬件攻击的成本。2016 年，IETF 将 scrypt 算法发布为 RFC 7914。<br><br>在输入中输入密码以生成其哈希。";

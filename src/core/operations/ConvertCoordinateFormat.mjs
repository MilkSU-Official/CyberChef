...
class ConvertCoordinateFormat extends Operation {
    ...
    constructor() {
        ...
        this.module = "Hashing";
        this.description = "在不同格式之间转换地理坐标。<br><br>支持的格式：<ul><li>度分秒 (DMS)</li><li>度十进制分 (DDM)</li><li>十进制度 (DD)</li><li>Geohash</li><li>军用网格参考系统 (MGRS)</li><li>英国国家网格 (OSNG)</li><li>通用横轴墨卡托投影 (UTM)</li></ul><br>此操作可以尝试自动检测输入坐标格式和分隔符，但这可能并不总是正确工作。";

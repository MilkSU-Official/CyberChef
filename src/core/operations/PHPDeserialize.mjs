...
class PHPDeserialize extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.description = "反序列化 PHP 序列化数据，将带键数组输出为 JSON。<br><br>此函数不支持 <code>object</code> 标签。<br><br>示例：<br><code>a:2:{s:1:&quot;a&quot;;i:10;i:0;a:1:{s:2:&quot;ab&quot;;b:1;}}</code><br>变为<br><code>{&quot;a&quot;: 10,0: {&quot;ab&quot;: true}}</code><br><br><u>输出有效 JSON：</u> JSON 不支持整数作为键，而 PHP 序列化支持。启用此选项将把这些整数转换为字符串。这也会转义反斜杠。";

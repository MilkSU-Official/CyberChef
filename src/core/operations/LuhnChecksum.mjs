...
class LuhnChecksum extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.description = "使用英文字母的 Luhn mod N 算法。Luhn mod N 算法是 Luhn 算法(也称为 mod 10 算法)的扩展,允许它处理任何偶数基数中的值序列。当需要校验位来验证由字母、字母和数字的组合或任意 N 个字符集(其中 N 可被 2 整除)组成的标识字符串时,这可能很有用。";

...
class MultipleBombe extends Operation {
    ...
    constructor() {
        ...
        this.description = "模拟用于攻击恩尼格玛密码机的 Bombe 机器。此版本执行多次 Bombe 运行以处理未知的转子配置。<br><br>在这里运行之前，您应该先在单个 Bombe 操作上测试您的菜单。有关选择明文的说明，请参阅 Bombe 操作的描述。<br><br>关于恩尼格玛、Typex 和 Bombe 操作的更详细描述<a href='https://github.com/gchq/CyberChef/wiki/Enigma,-the-Bombe,-and-Typex'>可以在这里找到</a>。";

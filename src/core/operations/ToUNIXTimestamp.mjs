...
class ToUNIXTimestamp extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.description = "解析 UTC 时间的日期时间字符串，并返回相应的 UNIX 时间戳。<br><br>例如：<code>Mon 1 January 2001 11:00:00</code> 变为 <code>978346800</code><br><br>UNIX 时间戳是一个 32 位值，表示从 1970 年 1 月 1 日 UTC（UNIX 纪元）以来的秒数。";

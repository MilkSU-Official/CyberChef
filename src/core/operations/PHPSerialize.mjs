...
class PHPSerialize extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.description = "对 JSON 数据执行 PHP 序列化。<br><br>此函数不支持 <code>object</code> 标签。<br><br>由于 PHP 不区分字典和数组，此操作与 <code>PHP Deserialize</code> 并不总是对称的。<br><br>示例：<br><code>[5,&quot;abc&quot;,true]</code><br>变为<br><code>a:3:{i:0;i:5;i:1;s:3:&quot;abc&quot;;i:2;b:1;}<code>";

...
class DESDecrypt extends Operation {
    ...
    constructor() {
        ...
        this.module = "Ciphers";
        this.description = "DES 是曾经占主导地位的加密算法，曾作为美国联邦信息处理标准（FIPS）正式发布。由于密钥长度较短，现在被认为是不安全的。<br><br><b>密钥:</b> DES 使用 8 字节（64 位）的密钥长度。<br><br><b>IV:</b> 初始化向量应为 8 字节长。如果未输入，将默认为 8 个空字节。<br><br><b>填充:</b> 在 CBC 和 ECB 模式下，默认使用 PKCS#7 填充。";

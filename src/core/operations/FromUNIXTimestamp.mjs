...
class FromUNIXTimestamp extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.description = "将 UNIX 时间戳转换为日期时间字符串。<br><br>例如 <code>978346800</code> 变为 <code>Mon 1 January 2001 11:00:00 UTC</code><br><br>UNIX 时间戳是一个 32 位值,表示从 1970 年 1 月 1 日 UTC(UNIX 纪元)以来的秒数。";

...
class FromBase85 extends Operation {
    ...
    constructor() {
        ...
        this.module = "Default";
        this.description = "Base85（也称为 Ascii85）是一种编码任意字节数据的表示法。它通常比 Base64 更高效。<br><br>此操作从 ASCII 字符串解码数据（使用您选择的字母表，包含预设）。<br><br>例如 <code>BOu!rD]j7BEbo7</code> 变为 <code>hello world</code><br><br>Base85 常用于 Adobe 的 PostScript 和 PDF 文件格式中。";
